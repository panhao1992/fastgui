# -*- coding;utf-8 -*-
"""
File name : item_tkintergui.PY
Create file time: 2023/1/17 14:16
...
class Picker(ttk.Frame):  # 选择器
    ...
    def __init__(self, master=None, activebackground='#b1dcfb', values=[], entry_wid=None, activeforeground='black',
        ...
        self.index = 0
        ttk.Frame.__init__(self, master, borderwidth=borderwidth, height=20, relief=relief)
        ...
        F = LabelFrame(self)
        F.pack(fill='x')
        self.canvas = Canvas(F, scrollregion=(0, 0, 500, (len(self._values) * 50)))
